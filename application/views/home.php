...
<body>
    ...
    <!-- Header untuk Nama dan Akses -->
        ...
        <div class="menu-container">
            <a href="<?php echo site_url('Antar/index'); ?>" class="w3-button w3-blue w3-card-4 menu-item">Menu Antar</a>
            <a href="<?php echo site_url('Jemput/index'); ?>" class="w3-button w3-green w3-card-4 menu-item">Menu Jemput</a>
            <a href="<?php echo site_url('Tracking/index'); ?>" class="w3-button w3-red w3-card-4 menu-item">Menu Tracking</a>
        </div>
    </div>
</body>
</html>
...
<style>
    ...
    .menu-item {
        padding: 20px;
        width: 30%; /* Lebar 30% agar menyisakan ruang di antara menu */
        text-align: center;
        font-size: 20px;
