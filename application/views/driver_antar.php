...
<body onload="initMap()">
    ...
    <div class="container">
        ...
        <table class="w3-table w3-striped w3-bordered">
            ...
            <tbody>
                <?php if (!empty($antar_data)): ?>
                    <?php foreach ($antar_data as $index => $antar): ?>
                        <tr>
                            <td><?php echo $antar['id_antar']; ?></td>
                            <td><?php echo $antar['username']; ?></td>
                            <td><?php echo $antar['alamat']; ?></td>
                            <td><?php echo $antar['nohp']; ?></td>
                            <td><?php echo $antar['dari']; ?></td>
                            <td><?php echo $antar['destination']; ?></td>
                            <td><?php echo $antar['start_lat']; ?></td>
                            <td><?php echo $antar['end_lat']; ?></td>
                            <td><?php echo $antar['start_lng']; ?></td>
                            <td><?php echo $antar['end_lng']; ?></td>
                            <td><button onclick="showRoute(<?php echo $antar['start_lat']; ?>, <?php echo $antar['start_lng']; ?>, <?php echo $antar['end_lat']; ?>, <?php echo $antar['end_lng']; ?>)">
                                Tampilkan Route
                            </button>
                            </td>
                        </tr>
