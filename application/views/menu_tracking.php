...
<body onload="initMap()">
    ...
    <!-- Header untuk Nama dan Akses -->
        ...
        <div class="menu-container">
            <a href="<?php echo site_url('Tracking/tracking_antar'); ?>" class="w3-button w3-blue w3-card-4 menu-item">Tracking Antar</a>
            <a href="<?php echo site_url('Tracking/tracking_jemput'); ?>" class="w3-button w3-red w3-card-4 menu-item">Tracking Jemput</a>
        </div>
    </div>
</body>
</html>
...
<style>
    ...
    .menu-item {
        padding: 20px;
        width: 50%; /* Lebar 30% agar menyisakan ruang di antara menu */
        text-align: center;
        font-size: 20px;
