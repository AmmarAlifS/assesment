...
<body onload="initMap()">
    ...
    <!-- Header untuk Nama dan Akses -->
        ...
        <div class="menu-container">
            <a href="<?php echo site_url('HomeDriver/lokasi_antar'); ?>" class="w3-button w3-blue w3-card-4 menu-item">Lokasi Antar</a>
            <a href="<?php echo site_url('HomeDriver/lokasi_jemput'); ?>" class="w3-button w3-red w3-card-4 menu-item">Lokasi Jemput</a>
        </div>
    </div>
</body>
</html>
